...
//get country Name from API and  convert it into full name
var countries = {
    "AFGHANISTAN": "AF",
    "ÅLAND ISLANDS": "AX",
    "ALBANIA": "AL",
  ...
  // Create an object to map codes to country names
  var fromCode = {};
  for (var country in countries) {
    var code = countries[country];
    fromCode[code.toUpperCase()] = country;
  }
  
  // Function to get country name by code
   function getCountry(code) {
    var upperCode = code.toUpperCase();
    return fromCode[upperCode] || "Country code not found";
  }
